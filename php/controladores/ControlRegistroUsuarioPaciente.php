<?php
	...
	while ($arreglo=mysql_fetch_array($resultado)) {
		...
		$sql3="insert into Pacientes (Pac_Nombre, Pac_Apellido, Pac_correo, Pac_curp, Pac_telefono, Pac_FecNac, Pac_sexo,idUsuarios)
		values ('$txtnombrepac','$txtapellido','$txtcorreo','$txtcurp','$txttelefono','$txtfecnac','$sexo',$idUsuario)";
         //echo $sql3;
		mysql_query($sql3);
	    if(mysql_query($sql3)){
