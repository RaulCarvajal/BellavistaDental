...
<body>
<h1>Opciones de administración -- Pacientes -- <a href="../PrincipalAdministrador.php">Regresar</a></h1>
...
<div class="divAcomodo">
    ...
    <form form class="w3-container" method="post" action="">
        ...
        <input class="w3-btn w3-red margenArriba" type="submit" name="Enviar" value="Modificar">
